...
start transaction;
insert into employee_e values('Adams', 'Ainslie St.', 'Chicago');
insert into employee_e values('Addison', 'Church St.', 'New York');
insert into employee_e values('Bruus', 'Bowler St.', 'Chicago');
insert into employee_e values('Bryant', 'Broad St.', 'New York');
insert into employee_e values('Carpenter', 'Churchill St.', 'Washington');
insert into employee_e values('Gimbert', 'Bowler St.', 'Washington');
insert into employee_e values('Grosvenor', 'Addison St.', 'New York');
insert into employee_e values('Gulley', 'Ainslie St.', 'Chicago');
insert into employee_e values('Hancock', 'Aldine Ave.', 'Washington');
insert into employee_e values('Hankey', 'Alexander St.', 'New York');
insert into employee_e values('Hawkins', 'Altgeld St.', 'Chicago');
insert into employee_e values('Henson', 'Ancona St.', 'Washington');
insert into employee_e values('Homer', 'Bloomingdale Ave.', 'New York');
insert into employee_e values('Jones', 'Blue Island Ave.', 'Chicago');
insert into employee_e values('Kelly', 'Bonaparte St.', 'Washington');
insert into employee_e values('Roberts', 'Bowler St.', 'New York');
insert into employee_e values('Rushton', 'Brighton Pl.', 'Chicago');
insert into employee_e values('Ryder', 'Broad St.', 'Washington');
insert into employee_e values('Sinclair', 'Church St.', 'New York');
insert into employee_e values('Slater', 'Churchill St.', 'Chicago');
insert into employee_e values('Smith', 'Cicero Ave.', 'New York');
insert into employee_e values('Spooner', 'Dickens Ave.', 'Washington');
insert into employee_e values('Stewart', 'Dobson Ave.', 'Chicago');
insert into employee_e values('Stokes', 'Dominick St.', 'Washington');
insert into employee_e values('Sutton', 'Altgeld St.', 'New York');
insert into employee_e values('Thomas', 'Bowler St.', 'Chicago');
insert into employee_e values('Tilstone', 'Church St.', 'Chicago');
